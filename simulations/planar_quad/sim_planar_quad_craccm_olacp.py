...
def run_craccm_simulation(
    ...
    wind_x = np.repeat(np.array([-3.00, -2.75, -3.05, -2.85]), 5)
...
def main():
    ...
    nominal_waypoints = np.array(
        [
            [0.000000000, 5.000000000, -0.029404417, 0.000000000, 0.000000000, 0.000000000],
            [0.572949017, 5.449138954, -0.024217445, 0.544406532, 0.401718823, 0.005150109],
            [2.072949017, 6.175861046, -0.009528192, 0.894021700, 0.248585204, 0.009118055],
            [3.927050983, 6.175861046, 0.009528192, 0.894021700, -0.248585204, 0.009118055],
            [5.427050983, 5.449138954, 0.024217445, 0.544406532, -0.401718823, 0.005150109],
            [6.000000000, 5.000000000, 0.029404417, 0.000000000, 0.000000000, 0.000000000],
            [5.427050983, 5.449138954, 0.024217445, -0.544406532, 0.401718823, -0.005150109],
            [3.927050983, 6.175861046, 0.009528192, -0.894021700, 0.248585204, -0.009118055],
            [2.072949017, 6.175861046, -0.009528192, -0.894021700, -0.248585204, -0.009118055],
            [0.572949017, 5.449138954, -0.024217445, -0.544406532, -0.401718823, -0.005150109],
    ...
    config = {
        ...
        "motion_planner_Q_f": np.diag([2500.0, 2500.0, 750.0, 250.0, 250.0, 150.0]),
